      ...
      {loading ? <div className="text-xs text-muted">Loading incumbent award history…</div>
        ...
        : data && <>
          ...
          <div className={styles.incumbentChartSwitch} role="tablist" aria-label="Award history chart">
            <button type="button" role="tab" aria-selected={chartView === 'activity'} className={chartView === 'activity' ? styles.historyControlActive : styles.historyControl} onClick={() => setChartView('activity')}>Activity history</button>
