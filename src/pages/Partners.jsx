      ...
      <div className={`card ${styles.workspace}`}>
        ...
        <section className={styles.profilePanel}>
          {editing ? <div className={styles.editProfile}>
            ...
            <div className={styles.profileHeader}><div><h2>{selected['Partner Name']}</h2><p>UEI: {selected['UEI Number']}</p></div><div className={styles.headerActions}><button className="btn text-sm" onClick={startEdit}>Edit</button><button className="btn btn-ghost text-sm" style={{ color: 'var(--red-600)' }} onClick={() => setDeleteTarget(selected)}>Delete</button></div></div>
